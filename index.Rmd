...
mdf$Measure<-factor(mdf$Measure,levels = c('Initiating and/or launching the process','Submitting proposals to the GCF Readiness and','Receiving approval from the GCF Readiness and','Formulating a mandate for the process','Defining institutional arrangements and a coo','Consulting stakeholders for input and validat','Synthesizing available adaptation information','Developing a road map for the process','Publishing the road map for the process','Analysing past climate data and scenarios of','Comprehensively assessing climate vulnerabili','Undertaking activities on integrating adaptat','Identifying adaptation options to address key','Appraising, prioritizing and ranking adaptati','Compiling draft NAPs for consultation and end','Publishing NAPs and submitting them to NAP Ce','Prioritizing climate change adaptation in nat','Designing coherent NAP implementation strateg','Implementing and managing actions in NAPs to','Designing and applying a monitoring and evalu','Communicating progress on NAPs','Monitoring and periodically reviewing the pro','Iteratively updating NAPs'))
