...
mdf<-as.data.frame(Measures[,-2])%>%reshape::melt(id.vars=c('Element', 'Measure'))
#Element_short<-paste(substr(mdf$Element,1,1),':-')

mdf$Measure<-factor(mdf$Measure,levels = c('A:-Initiating and/or launching the process','A:-Submitting proposals to the GCF Readiness and','A:-Receiving approval from the GCF Readiness and','A:-Formulating a mandate for the process','A:-Defining institutional arrangements and a coo','A:-Consulting stakeholders for input and validat','A:-Synthesizing available adaptation information','A:-Developing a road map for the process','A:-Publishing the road map for the process','B:-Analysing past climate data and scenarios of','B:-Comprehensively assessing climate vulnerabili','B:-Undertaking activities on integrating adaptat','B:-Identifying adaptation options to address key','B:-Appraising, prioritizing and ranking adaptati','B:-Compiling draft NAPs for consultation and end','B:-Publishing NAPs and submitting them to NAP Ce','C:-Prioritizing climate change adaptation in nat','C:-Designing coherent NAP implementation strateg','C:-Implementing and managing actions in NAPs to','D:-Designing and applying a monitoring and evalu','D:-Communicating progress on NAPs','D:-Monitoring and periodically reviewing the pro','D:-Iteratively updating NAPs'))
